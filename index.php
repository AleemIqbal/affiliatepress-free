...
<div class="front-section">
    <div class="first-section">
        ...
        <div class="first-post">
            <a class="first-post__link" aria-label="<?php the_title() ?>" href="<?php the_permalink() ?>"></a>
            ...
            <div class="first-post__data">
                ...
                <div class="first-post__excerpt"><?php the_custom_excerpt() ?></div>
    ...
    <div class="other-section">
        <?php while ($other_posts->have_posts()) : $other_posts->the_post() ?>
            <div class="other-post">
                <a class="other-post__link" aria-label="<?php the_title() ?>" href="<?php the_permalink() ?>"></a>
    ...
    <div class="popular-posts">
        ...
        if ($popular_posts->have_posts()) : while ($popular_posts->have_posts()) : $popular_posts->the_post(); ?>
                <div class="popular-post">
                    <a class="popular-post__link" aria-label="<?php the_title() ?>" href="<?php the_permalink() ?>"></a>
    ...
    <div class="latest-posts">
        ...
        if ($latest_posts->have_posts()) : while ($latest_posts->have_posts()) : $latest_posts->the_post() ?>
                <article class="latest-post hentry">
                    <a class="latest-post__link" aria-label="<?php the_title() ?>" href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute() ?>"></a>
