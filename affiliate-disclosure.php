...
if (have_posts()) : while (have_posts()) : the_post(); ?>
        <div <?php post_class() ?> id="post-<?php the_ID(); ?>">
            ...
            <div class="entry-content">
                ...
                <p>Any/all of the links on <?php echo get_bloginfo("name") ?> are affiliate links for which I receive a small compensation from sales of certain items.</p>
                <h2>What Are Affiliate Links?</h2>
                <p>Purchases are made on external affiliate company websites: when a reader clicks on an affiliate link located on <?php echo get_bloginfo("name") ?> to purchase an item, the reader buys the item from the seller directly (not from <?php echo get_bloginfo("name") ?>).</p>
                <p>Amazon and/or other companies pay <?php echo get_bloginfo("name") ?> a small commission or other compensation for helping to bring customers to their website.</p>
                ...
                <p><?php echo get_bloginfo("name") ?> uses two main types of affiliate programs:</p>
                <h2>1. Amazon affiliate links.</h2>
                <p><a href="<?php echo esc_url( home_url() ) ?>"><?php echo get_bloginfo("name") ?></a> is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for website owners to earn fees by linking to Amazon.com and affiliated sites, as well as to other websites that may be affiliated with Amazon Service LLC Associates Program.</p>
                ...
                <p>I do not write sponsored posts. I want to provide authentic, un-biased information. However, if a company would like to publish sponsored content on <?php echo get_bloginfo("name") ?>, I will disclose this clearly in the beginning of the post.</p>
